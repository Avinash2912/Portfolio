...
export default function ProjectCard({ 
  ...
  return (
    <div className="max-w-[280px] bg-gray-900  rounded-xl overflow-hidden border border-cyan-800/30 hover:border-cyan-600/50 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-xl hover:shadow-cyan-500/20 p-4 m-4">
      {/* Image Container */}
