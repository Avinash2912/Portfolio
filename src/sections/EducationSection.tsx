...
//     >
//       {/* College Information */}
//       <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl p-6 mb-6 border border-gray-700/50">
//         <div className="flex items-center mb-4">
//           <GraduationCap className="w-8 h-8 text-indigo-400 mr-4" />
//           <h2 className="text-2xl font-bold">Guru Gobind Singh Indraprastha University</h2>
//           <span className='ml-auto'>CGPA: 8.675</span>
//         </div>
...
//         <div className="flex items-center mb-4">
//           <GraduationCap className="w-8 h-8 text-indigo-400 mr-4" />
//           <h2 className="text-2xl font-bold">Poorna Prajna Public School</h2>
//           <span className='ml-auto'>Percentage: 75%</span>
//         </div>
...
//           <div className="flex items-center text-gray-300">
//             <Award className="w-5 h-5 mr-3" />
//             <span>Senior Secondary Education, PCM</span>
//           </div>
//         </div>
//       </div>
//     </motion.div>
